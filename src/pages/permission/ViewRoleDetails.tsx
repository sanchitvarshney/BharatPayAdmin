  ...
  const columns: GridColDef[] = [
    {
      ...
      renderCell: (params: any) => (
        <div className="flex items-center">
          <img src={params.row.adminImage} alt="Admin" style={{ width: 30, height: 30, borderRadius: "50%", marginRight: 8 }} />
          <p>{params.value}</p>
        </div>
      ),
    },
    ...
    },
    {
      ...
      headerName: "Type",
      flex: 1,
      renderCell: (params: any) => <span style={{ textTransform: "capitalize" }}>{params.value === "admin" ? "Admin" : "User"}</span>,
    },
  ];
